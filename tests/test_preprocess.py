        ...
        data = pd.DataFrame(
            {
                ...
                "text": [
                    "This is a very long text that should be detected as text type",
                    "Another very long text that should be detected as text type",
                    "This is also a very long text that should be detected as text type",
                    "Very long text here that should be detected as text type",
                    "This is a medium length text that should be detected as text type",
                ],
            }
        )
