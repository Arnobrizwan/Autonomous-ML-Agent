...
from src.aml_agent.models import ModelTrainer, ModelRegistry, get_model_factory
...
from src.aml_agent.types import ModelType, TaskType, MetricType, SearchStrategy
...
class TestModelTraining:
    ...
    def test_model_registry(self):
        ...
        lr_classifier = registry.get_model_class(ModelType.LOGISTIC_REGRESSION, TaskType.CLASSIFICATION)
        assert lr_classifier is not None
        
        lr_regressor = registry.get_model_class(ModelType.LINEAR_REGRESSION, TaskType.REGRESSION)
    ...
    def test_ensemble_creation(self):
        ...
        from src.aml_agent.types import TrialResult, MetricType
    ...
    def test_model_evaluation_metrics(self):
        ...
        from src.aml_agent.models.train_eval import evaluate_model, cross_validate_model
    ...
    def test_regression_models(self):
        ...
        data = create_sample_data(n_samples=100, n_features=5, task_type=TaskType.REGRESSION)
        X = data.drop(columns=['target'])
        y = data['target']
