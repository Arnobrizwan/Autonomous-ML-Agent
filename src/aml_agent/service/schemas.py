...
class PredictionResponse(BaseModel):
    ...
    prediction: Union[int, float, List[float]] = Field(..., description="Prediction result")
...
class BatchPredictionRequest(BaseModel):
    ...
    data: Union[List[Dict[str, Union[str, int, float]]], str] = Field(..., description="Batch data or CSV string")
    run_id: str = Field(..., description="Run ID of the trained model")
...
class BatchPredictionResponse(BaseModel):
    ...
    predictions: List[Union[int, float, List[float]]] = Field(..., description="Batch predictions")
