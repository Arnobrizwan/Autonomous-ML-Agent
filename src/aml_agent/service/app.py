...
class ModelService:
    ...
    def predict_single(self, features: Dict[str, Any]) -> PredictionResponse:
        ...
        try:
            ...
            return PredictionResponse(
                prediction=float(prediction) if isinstance(prediction, (int, float)) else prediction.tolist(),
    ...
    def predict_batch(self, data: Union[List[Dict[str, Any]], str]) -> BatchPredictionResponse:
